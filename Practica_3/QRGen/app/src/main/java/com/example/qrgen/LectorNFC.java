...
public class LectorNFC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lector_nfc);
    ...
    public void onNewIntent(Intent intent) {
        ...
        String tagId;
        if(tag != null) tagId = Utils.bytesToHex(tag.getId());
        else tagId = Utils.bytesToHex(null);
