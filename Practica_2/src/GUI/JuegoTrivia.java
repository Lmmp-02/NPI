...
public class JuegoTrivia extends javax.swing.JPanel {
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            shuffleOptions(currentQuestion); // Opcional: Mezclar opciones

            jButton1.setText(options[0]);
            jButton1.addActionListener((ActionEvent e) -> handleAnswer(options[0], jButton1));

            jButton2.setText(options[1]);
            jButton2.addActionListener((ActionEvent e) -> handleAnswer(options[1], jButton2));

            jButton3.setText(options[2]);
            jButton3.addActionListener((ActionEvent e) -> handleAnswer(options[2], jButton3));
    ...
    private void startTimer() {
        jLabel2.setText("Tiempo: " + QUESTION_TIME);
        questionTimer = new Timer(1000, new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (timeLeft > 0) {
                    jLabel2.setText("Tiempo: " + --timeLeft);
                } else {
...
private void handleTimeout() {
    ...
    // Deshabilitar y cambiar el color de los botones según la respuesta correcta
    updateButtonState(jButton1, correctAnswer);
    updateButtonState(jButton2, correctAnswer);
    updateButtonState(jButton3, correctAnswer);
...
private void updateButtonState(JButton button, String correctAnswer) {
    button.setEnabled(false); // Deshabilitar botón
    if (button.getText().equalsIgnoreCase(correctAnswer)) {
        button.setBackground(Color.GREEN); // Marcar respuesta correcta
    }
}
...
private void handleAnswer(String selectedOption, JButton selectedButton) {
    ...
    Question currentQuestion = questions.get(currentQuestionIndex);
    String correctAnswer = currentQuestion.getAnswer(); // Obtener la respuesta correcta
...
private void resetButtonColors() {
    ...
    // Eliminar ActionListeners para evitar acciones múltiples
    removeButtonActionListeners(jButton1);
    removeButtonActionListeners(jButton2);
    removeButtonActionListeners(jButton3);
}
...
private void removeButtonActionListeners(JButton button) {
    ...
    // Cambiar la vista o realizar otras acciones de limpieza
    }
    ...
    private void initComponents() {
        ...
        jButton1.setMaximumSize(new java.awt.Dimension(350, 200));
        jButton1.setMinimumSize(new java.awt.Dimension(350, 200));
        jButton1.setPreferredSize(new java.awt.Dimension(350, 200));
